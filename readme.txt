...
IMPORTANT UPDATE:
Microsoft has made changes to their translation API which is preventing new activations from working. We are working on updated version of the plugin to work around this. Existing users who have already activated their API key should be unaffected. 
